# -*- coding: utf-8 -*-
"""Dedicated file logger for ETF query traces."""
...
_LOGGER_NAME = "theme_picker.etf_query"
_DEFAULT_FILENAME = "etf-query.log"
_LOGGER_LOCK = Lock()


def _get_etf_query_logger() -> logging.Logger:
...
def emit_etf_query_log(
    ...
    *,
    ...
    try:
        ...
        query_logger = _get_etf_query_logger()
    except Exception:
        return
