...
def normalize_trade_candidate(trade: dict[str, Any], *, run_name: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        "entry_price": to_float(trade.get("entry_price"), default=None),
        "exit_price": to_float(trade.get("exit_price"), default=None),
        "shares": to_int(trade.get("shares")),
        ...
        "net_pnl": to_float(trade.get("net_pnl"), default=None),
        "gross_pnl": to_float(trade.get("gross_pnl"), default=None),
